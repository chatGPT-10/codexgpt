...
- Phase 1, Phase 2A, Phase 2B, Phase 3A, and Phase 3B are published. STEP-277 commit `88bd4b9` passed exact-head CI run `29369658101` across Ubuntu/Windows Node 20/24; Phase 3C–3D remain next.
