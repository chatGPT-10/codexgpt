...
CodexPro is not a hosted coding service, model proxy, quota bypass, account pool, or operating-system sandbox. It is not an OS sandbox.
...
```powershell
$env:CODEXPRO_TOOL_CONTRACT_VERSION = "2"
$env:CODEXPRO_FILE_TRANSACTIONS = "atomic"
$env:CODEXPRO_AUDIT_MODE = "required"
$env:CODEXPRO_AUDIT_RETENTION_DAYS = "30"
$env:CODEXPRO_AUDIT_RETENTION_BYTES = "104857600"
```
