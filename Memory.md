...
1. Stage and publish the final reviewed STEP-397 candidate, then require terminal exact-head Repository policy plus Ubuntu/Windows Node 20/24 Build, Regression, Smoke, and Package success. Do not create an evidence-only follow-up commit after success.
