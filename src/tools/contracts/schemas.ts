...
import type { CanonicalToolV2 } from "./types.js";

export type ContractSchemaMap = Readonly<Partial<Record<CanonicalToolV2, z.ZodTypeAny>>>;
...
export function assertCompleteContractSchemaMap(
  ...
  const extra = actual.filter((name) => !expected.includes(name as CanonicalToolV2));
