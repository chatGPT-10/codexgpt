...
export function gitStatus(config: CodexGPTConfig, workspace: Workspace, guard?: PathGuard, filePath?: string, staged = false): string {
  const args = staged
...
export function gitDiff(config: CodexGPTConfig, guard: PathGuard, workspace: Workspace, filePath?: string, staged = false): string {
...
export function gitDiffStatus(config: CodexGPTConfig, guard: PathGuard, workspace: Workspace, filePath?: string, staged = false): string {
...
export function gitLog(config: CodexGPTConfig, workspace: Workspace, maxCount = 8): string {
