...
- Aligned the detached-run flood regression deadline with the production worker-lease boundary plus bounded publication grace, so CI load cannot fail a still-observable runner after an unrelated fixed 15-second test timeout.
